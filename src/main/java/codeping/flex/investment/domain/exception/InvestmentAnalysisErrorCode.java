...
public enum InvestmentAnalysisErrorCode implements BaseErrorCode {
    ...
    GET_STOCK_RANKING_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "INVESTMENT_ANALYSIS_003", "주식 순위 조회에 실패했습니다."),
    PROMPT_GENERATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "INVESTMENT_ANALYSIS_004", "AI 분석 프롬프트 생성에 실패했습니다."),
    INVALID_API_RESPONSE(HttpStatus.INTERNAL_SERVER_ERROR, "INVESTMENT_ANALYSIS_005", "AI 분석 결과 생성에 실패했습니다.");
